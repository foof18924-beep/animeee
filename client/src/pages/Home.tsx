      ...
      <nav className="sticky top-0 z-50 bg-slate-900/95 backdrop-blur border-b border-slate-700">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="flex gap-4">
            ...
            <a href="/admin" className="hover:text-green-400 transition text-sm">
              لوحة التحكم
            </a>
          </div>
        </div>
          ...
          <div className="max-w-2xl mx-auto">
            <Accordion type="single" collapsible className="space-y-2">
              ...
              <AccordionItem value="q5" className="bg-slate-800 border-slate-700 px-4 rounded">
                ...
                <AccordionContent className="text-slate-300">
                  قم بتنزيل ملف APK من الزر أعلاه، ثم افتح الملف على هاتفك. قد تحتاج إلى تفعيل
                  خيار "تثبيت من مصادر غير معروفة" في إعدادات الأمان.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="q6" className="bg-slate-800 border-slate-700 px-4 rounded">
                <AccordionTrigger className="hover:text-green-400">
                  هل التطبيق يعمل على جميع أجهزة أندرويد؟
                </AccordionTrigger>
                <AccordionContent className="text-slate-300">
                  التطبيق يعمل على معظم أجهزة أندرويد. يُنصح بوجود أندرويد 5.0 أو أحدث للحصول على
                  أفضل أداء.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
      ...
      <section className="py-16 bg-gradient-to-r from-green-600 to-green-700">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg mb-8 text-green-100">
            حمل تطبيق ياسين تي في الآن واستمتع بالبث المباشر المجاني
          </p>
          <Button
            onClick={handleDownload}
            disabled={isLoading}
            className="bg-white text-green-700 hover:bg-slate-100 px-8 py-6 text-lg font-bold"
          >
            <Download className="mr-2 h-5 w-5" />
            {isLoading ? "جاري التحميل..." : "تنزيل الآن"}
          </Button>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a href="#faq" className="text-slate-400 hover:text-green-400">
                    الأسئلة الشائعة
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <a href="/privacy" className="text-slate-400 hover:text-green-400">
                    سياسة الخصوصية
                  </a>
                </li>
                <li>
                  <a href="/terms" className="text-slate-400 hover:text-green-400">
                    الشروط والأحكام
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <a href="/contact" className="text-slate-400 hover:text-green-400">
                    اتصل بنا
                  </a>
                </li>
                <li>
                  <a href="/disclaimer" className="text-slate-400 hover:text-green-400">
                    تنصل
                  </a>
                </li>
              </ul>
